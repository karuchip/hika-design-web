...
const BlogDetailPage = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <div className="pt-36 bg-[#FCFCFC] lg:flex lg:gap-[40px] lg:justify-center">

      {/* 左サイド */}
      <div className="w-max-[360px] lg:max-w-[864px] md:min-w-[664px] mx-[20px] lg:mx-0 mb-[20px] h-auto bg-[#ffffff] rounded-3xl shadow-lg">
        {/* ラベル画像 */}
