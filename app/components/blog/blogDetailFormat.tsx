...
const BlogDetailFormat = ({onePost}:Props) => {
  ...
  // Xへの投稿文言
  const text = `【個人開発】${onePost.title} --- UI/UXやフロントエンド開発の学習記録をまとめています ---`;
    ...
    <>
      ...
      <div className="lg:flex lg:gap-[60px] lg:justify-center z-0">
        ...
        <div className="mb-[20px] lg:mb-[200px]">
          ...
          <div className="w-max-[360px] lg:max-w-[864px] md:min-w-[664px] mx-[20px] lg:mx-0 h-auto bg-[#ffffff] rounded-3xl shadow-lg">
            {/* ラベル画像 */}
