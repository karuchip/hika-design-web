...
const Chapter = ({onePost}:Props) => {
  return(
    <div className="w-[300px] rounded-3xl shadow-lg text-[#586869] bg-[#ffffff]">
      <div className="w-[260px] mx-auto py-[15px]">
            ...
            if(item.level === 1 ) {
              return(
                <div key={item.id} className="w-fit mt-2 mb-1">
                  <a href={`#${item.id}`}>
                    <p className="text-[16px] md:text-[18px] font-">{item.content}</p>
              ...
              return (
                <div key={item.id} className="w-fit mb-1">
                  <a  href={`#${item.id}`}>
                    <p className="text-[14px] md:text-[16px] font-normal"><span>・</span>{item.content}</p>
                  </a>
                </div>
              )
            }
