      ...
      <div className="w-[260px] mx-auto py-[5px] lg:py-[15px]">
        ...
        {headings.map((item)=> {
          if(item.type === "heading"){
            if(item.level === 1 ) {
              return(
                <div key={item.id} className="w-full mt-2 mb-1">
                  <a href={`#${item.id}`}>
                    <p className={`text-[16px] md:text-[18px] hover:text-[#000000] mt-3
              ...
              return (
                <div key={item.id} className="w-full mb-1">
                  <a  href={`#${item.id}`}>
                    <p className={`text-[14px] md:text-[16px] font-normal hover:text-[#000000] hover:font-bold
                      ${activeHeading === item.id
                          ? "text-black font-bold bg-[#F0ECEC]"
                          : "text-[#586869]"
                      }
